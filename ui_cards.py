...
class Ui_Cards(object):
    def setupUi(self, Cards):
        ...
        self.gridLayoutWidget.setGeometry(QRect(10, 150, 781, 441))
        ...
        self.lcd_time.setGeometry(QRect(310, 30, 171, 91))
    ...
    def retranslateUi(self, Cards):
        Cards.setWindowTitle(QCoreApplication.translate("Cards", u"CardGame", None))
